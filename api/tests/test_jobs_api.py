...
@patch("api.app.routes.jobs.get_db_connection")
@patch("api.app.routes.jobs.get_queue_depth")
@patch("api.app.routes.jobs.create_job")
...
@patch("api.app.routes.jobs.get_db_connection")
@patch("api.app.routes.jobs.get_job_by_id")
